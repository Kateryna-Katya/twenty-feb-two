            ...
            <div class="legal-content">
                ...
                <div data-aos="fade-up">
                    ...
                    <p>
                        ...
                        (логин, язык, настройки региона Великобритания и другие параметры) 
                ...
                <div data-aos="fade-up">
                    ...
                    <p>
                        Мы классифицируем файлы cookie, используемые на сайте <strong><?= $fullDomain ?></strong>, по следующим категориям:
                    </p>
                    <ul class="legal-list">
                        <li>
                        ...
                        <li>
                            <strong>Функциональные:</strong> Позволяют запоминать ваш выбор для персонализированного опыта в рамках консалтинг-услуг.
                        </li>
                        <li>
                ...
                <div data-aos="fade-up">
                    ...
                    <ul class="legal-list">
                        ...
                        <li>Персонализация предложений для пользователей в Англии.</li>
                ...
                <div class="contact-info-block" data-aos="zoom-in">
                    ...
                    <p>
                        Если у вас возникли вопросы касательно политики на <strong><?= $domainTitle ?></strong>, свяжитесь с нашей командой поддержки:
                    </p>
                    <ul class="contact-data">
                        ...
                        <li><strong>Адрес:</strong> 22 Bishopsgate, London EC2N 4BQ, United Kingdom</li>
                    </ul>
                </div>
            </div>
        </div>
