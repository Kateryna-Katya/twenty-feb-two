        ...
        <div class="container">
            ...
            <div class="legal-content">
                <div class="policy-intro" data-aos="fade-up">
                    ...
                    <p>
                        1.2. Настоящая Политика применяется ко всей информации о посетителях веб-сайта <strong><?= $fullDomain ?></strong>.
                    </p>
                </div>
                ...
                <div class="policy-section" data-aos="fade-up">
                    ...
                    <ul class="terminology-list">
                        <li>
                            ...
                            Информационные материалы, доступные по адресу <?= $fullDomain ?>.
                        </li>
                        <li>
                            <strong>Пользователь</strong>
                            Любой посетитель платформы <?= $domainTitle ?>.
                        </li>
                        <li>
                            <strong>Персональные данные</strong>
                            Информация, относящаяся прямо или косвенно к Пользователю.
                        </li>
                        <li>
                            <strong>Обработка данных</strong>
                            Сбор, запись, хранение и обновление информации.
                        </li>
                    </ul>
                </div>
                ...
                <div class="policy-section" data-aos="fade-up">
                    ...
                    <ul class="legal-list">
                        ...
                        <li>Обеспечение доступа Пользователя к сервисам платформы.</li>
                        <li>Улучшение качества консалтинговых материалов.</li>
                        <li>Персонализация предложений для региона Великобритания.</li>
                    </ul>
                </div>

                <div class="policy-section contact-footer-policy" data-aos="zoom-in">
                    <h2>5. Вопросы и отзывы</h2>
                    <p>Если у вас возникли вопросы касательно обработки ваших данных, вы можете направить запрос на наш официальный адрес:</p>
